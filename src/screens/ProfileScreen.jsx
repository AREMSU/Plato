...
export default function ProfileScreen({ navigation }) {
  ...
  const MenuItem = ({ iconSource, label, value, onPress, color }) => (
    ...
    >
      ...
      >
        <Text style={styles.menuIconEmoji}>{iconSource}</Text>
      </View>
  ...
  return (
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.menuSection}>
          <Text style={styles.menuSectionTitle}>MEMBERSHIP</Text>
          <MenuItem
            iconSource={PROFILE_ICONS.payment}
            label="Premium Plans"
            value={user?.subscription === 'free' ? 'Free' : '👑 ' + user?.subscription}
            color={user?.subscription === 'free' ? '#9E9E9E' : '#FF6B35'}
          ...
          <View style={styles.modalContainer}>
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity onPress={() => setEditModalVisible(false)}>
                <Text style={styles.modalCloseIconEmoji}>❌</Text>
              </TouchableOpacity>
            </View>
                ...
                <View style={styles.modalAvatarButtons}>
                  ...
                  {user?.avatar && (
                    <TouchableOpacity
                      ...
                      onPress={removeAvatar}
                    >
                      <Text style={styles.modalAvatarBtnIconEmoji}>🗑️</Text>
